...
class Airport:
    def __init__(self, initCode, initLatitudeDegrees,
        initLatitudeMinutes, initLongitudeDegrees, initLongitudeMinutes):
        self.code = initCode
    ...
    def calculateDistance(a1, a2):
        ...
        lat1 = (a1.latitudeDegrees + a1.latitudeMinutes / 60.0) / RADIAN_FACTOR
        long1 = (-a1.longitudeDegrees + a1.longitudeMinutes / 60.0) / RADIAN_FACTOR
        lat2 = (a2.latitudeDegrees + a2.latitudeMinutes / 60.0) / RADIAN_FACTOR
        long2 = (-a2.longitudeDegrees + a2.longitudeMinutes / 60.0) / RADIAN_FACTOR
